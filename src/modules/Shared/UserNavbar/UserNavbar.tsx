  ...
  return (
    <>
      <Grid sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', py: 1, px: 2 }}>
        ...
        <Box>
          <Button variant="contained" size="large" onClick={() => navigate("/favourites")}>Favourites</Button>
          <Button variant="contained" size="large" onClick={() => navigate("/explore-rooms")} sx={{ ml: 1 }}>Explore Rooms</Button>
